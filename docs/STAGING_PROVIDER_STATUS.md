...
- Published hardening build: `4209855b11903d085393fc9a017ae2e159b88f65`.
...
- Current local gates: 59 unit tests, 9 Firestore/Storage emulator tests, production build, zero production dependency vulnerabilities, clean secret scan. The emulator suite now proves that provider inboxes retain only payload digests, completed outbox payloads are redacted, and final account deletion pseudonymizes linked orders/ledger rows while canceling unfinished personal side effects.
