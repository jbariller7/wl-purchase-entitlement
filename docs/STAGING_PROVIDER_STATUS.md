...
- Verified production UI/application build: `6ffa53e` (Netlify deploy `6a8cee6e8e7bfb0008ed03aa`). The published cloud-save retention/cleanup baseline is `580511e` (Netlify deploy `6a8ce2733483ab0008e01166`), the secure NW.js device-sign-in baseline is `4f62c63`, and the earlier honest-UI baseline was `cfd177b`.
