...
export const POLYGLOT_PERMANENT_PRICE_USD_CENTS = 3199;
export const PREMIUM_LIFETIME_PRICE_USD_CENTS = 5999;
/** @deprecated Use PREMIUM_LIFETIME_PRICE_USD_CENTS. */
export const LIFETIME_PRICE_USD_CENTS = PREMIUM_LIFETIME_PRICE_USD_CENTS;
...
> = {
  ...
  desktop_lifetime: { fullGame: false, allLanguages: false, cloudSave: false, pcMacAccess: true }
};
...
export const LEGACY_PLAY_PRODUCT_MAP: Record<string, Product> = {
  ...
  wonderlangfull: "mobile_polyglot_permanent"
};
